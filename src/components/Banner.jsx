...
const Banner = () => {
  return (
    <section>
      ...
      <Container className='absolute top-0 bottom-0 lg:py-10 pl-10 lg:pl-20'>
        <div className="lg:flex grid grid-cols-1 w-75 lg:w-full justify-between items-center pt-25 lg:pt-10">
          ...
          <div>
            <img className='shadow-[#1d9bf0] shadow-lg h-100 rounded-lg lg:pr-3.5' src={SelfImg} alt="#" />
          </div>
        </div>
      </Container>
    </section>
